...
export function ContactForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="rounded-xl border border-brand-border bg-white p-6">
      <h3 className="text-base font-bold text-brand-navy">Gửi yêu cầu liên hệ</h3>
      ...
      <button
        type="submit"
        className="mt-5 flex w-full items-center justify-center gap-2 rounded-lg bg-brand-orange px-5 py-3 text-sm font-semibold text-white hover:bg-brand-orange-dark"
      >
        Gửi yêu cầu ngay
      </button>
    </form>
